...
1. Copy the `philips_sicp_display` folder into `custom_components/philips_sicp_display` in your Home Assistant instance. The directory name must match the `domain` in `manifest.json`.
